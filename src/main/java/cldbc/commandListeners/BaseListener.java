...
import cldbc.commands.BaseCommand;
import cldbc.commands.AliasParamCmd;
...
public abstract class BaseListener implements CommandListener {
    ...
    protected void printUnknownCommandStack() {
        ...
        System.out.println("If you want to init cldbc.connection: " + MainClientListener.CommandSet.CONNECT.getCommandText() +

...
public class MainClientListener extends BaseListener implements CommandListener {
    ...
    public enum CommandSet {
        ...
        CONFIG("cfg", " - usage: cfg 'alias_name'; Shows current cldbc.connection configuration"),
        HELP("help", " - shows available cldbc.commands"),
        CONNECT("con", " - usage: con 'alias_name'"),
        CLOSE("close", " - close current cldbc.connection"),
